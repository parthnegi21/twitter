...
onClick={()=>{
  router.push("/chat")
}} className="flex cursor-pointer hover:bg-gray-900 xl:pr-2 w-12 xl:w-40 h-12 items-center rounded-3xl justify-center">
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="sm:size-9  size-8">
...
<div onClick={()=>{
  router.push("/profile")
}} className="flex cursor-pointer hover:bg-gray-900 w-12 xl:w-32 h-12 items-center rounded-3xl justify-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="sm:size-9  size-8">
